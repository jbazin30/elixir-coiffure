...
class awImage {
    ...
    public static function drawError($message) {
        ...
        $driver->filledRectangle(
                ...
                new awPoint(0, 0), new awPoint($width, $height)
                )
        );

        $driver->filledRectangle(
                new awRed, new awLine(
                new awPoint(0, 0), new awPoint(110, 25)
                )
        );

        $text = new awText(
                "Artichow error", new awFont3, new awWhite, 0
        );
        ...
        $driver->rectangle(
                new awRed, new awLine(
                new awPoint(0, 25), new awPoint($width - 90, $height - 1)
                )
        );
        ...
        // Draw message
        $text = new awText(
                strip_tags($message), new awFont2, new awBlack, 0
        );
