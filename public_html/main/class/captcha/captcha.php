...
abstract class Captcha {
    ...
    protected function generate_color() {
        ...
        do {
            ...
            if (($check_color[$this->color_level][1] == '<' && $color < $check_color[$this->color_level][0]) || ($check_color[$this->color_level][1] == '>' && $color > $check_color[$this->color_level][0])) {
                $ok = TRUE;
            }
        } while (!$ok);
    ...
    protected function method_classic() {
        $this->fill_data();
        $this->explain = Header::$lang->lang('captcha_method_classic');
    }
    ...
    protected function method_maths() {
        ...
        $this->fill_data();
        $this->explain = Header::$lang->lang('captcha_method_maths');
    }
    ...
    protected function method_color($word = NULL, $info = NULL) {
        ...
        $this->explain = sprintf(Header::$lang->lang('captcha_method_color'), Header::$lang->lang('captcha_color_' . $selected_color));
