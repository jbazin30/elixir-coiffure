...
<div id="main-wrapper">
    <div class="container">
        ...
        <div class="mtl">
            ...
            <form enctype="multipart/form-data" name="contact" action="contact.html" method="POST" class="w70 center">
                <p><label>Nom : </label><input type="text" name="nom" value="" placeholder="Nom" required /></p>
                <p><label>Prénom : </label><input type="text" name="prenom" value="" placeholder="Prénom" required /></p>
                <p><label>E-mail : </label><input type="text" name="email" value="" placeholder="Email" required /></p>
                <p><label>Téléphone : </label><input type="text" name="tel" value="" placeholder="Téléphone" required /></p>
                <p><label>Pièce jointe : </label><input type="file" name="piece_jointe" /></p><!-- permettre l'ajout de X fichiers -->
                <p><label>Message : </label><textarea name="message" rows="4" cols="20" required></textarea></p>
                <p><input type="submit" value="Envoyer" name="send" /></p>
            </form>
            <!-- ENDIF -->
            <!-- IFEXIST is_posted -->
            <p class="t_center">Votre message à bien été envoyé</p>
            <!-- ENDIF -->
        </div>
    </div>
</div>
