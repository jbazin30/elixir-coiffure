...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./templates/assets/css/main.min.css" />
                ...
                <div id="header">
                    ...
                    <nav id="nav">
                        <ul>
                            ...
                            <li><a href="mes-produits.html">Mes produits</a></li>
                            <li><a href="book.html">Book</a><!-- Galerie photo avec arbo : coupe-coiffage / extensions / lissage-défrisage / coiffures-chignons --></li>
